...
import { Upload, Zap, Trophy, Clock, Download, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
      ...
      >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="px-2 py-0.5 bg-orange-500/20 text-orange-400 text-xs rounded-full border border-orange-500/30 font-medium">
              Most Exciting
            </span>
          </div>
        ...
        <div className="px-4 pb-4 border-t border-gray-700 pt-3">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs text-gray-400">
              Peak energy at {formatTime(highlight.peak_time)} — crowd/crowd intensity: <span className="text-orange-400 font-semibold">{highlight.energy_score.toFixed(1)}%</span>
            </span>
          </div>
          <video
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg text-sm font-medium transition-colors"
          >
            <Download size={14} />
            Download Clip
          </a>
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="border-b border-gray-800 bg-gray-900/80 backdrop-blur sticky top-16 z-10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Sports Highlight Generator</h1>
            <p className="text-gray-400 text-xs">Detects exciting moments using crowd noise &amp; audio energy analysis</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-5">
            <h2 className="font-semibold text-white mb-3 flex items-center gap-2">
              <Upload size={16} className="text-orange-400" /> Upload Video
            </h2>
            <div
            ...
            >
              {file ? (
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Click to upload sports video</p>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-5 space-y-4">
            <h2 className="font-semibold text-white flex items-center gap-2">
              <Zap size={16} className="text-orange-400" /> Configuration
            </h2>

            <div>
              <div className="flex justify-between mb-1">
                <label className="text-gray-300 text-sm">Number of Highlights</label>
                <span className="text-orange-400 font-bold text-sm">{numClips}</span>
              </div>
              <input
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-orange-400 font-bold text-sm">{clipDuration}s</span>
              </div>
              <input
          ...
          {isProcessing && (
            <div className="bg-gray-800 border border-gray-700 rounded-xl p-4">
              <div className="flex justify-between mb-2">
                ...
                <span className="text-orange-400 text-sm font-bold">{progress}%</span>
              </div>
              ...
              <div className="space-y-1">
                {STEPS.map((step, i) => {
                  ...
                  return (
                    <div key={i} className={`text-xs flex items-center gap-2 ${done ? 'text-green-400' : active ? 'text-orange-400' : 'text-gray-600'}`}>
        ...
        <div>
          {highlights.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <p className="text-gray-600 text-sm mt-1">Upload a sports video and click Generate</p>
            </div>
          )}
        </div>
      </div>
