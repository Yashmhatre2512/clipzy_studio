...
from utils.process_highlights import allowed_file, process_highlights
...
def upload_video():
    try:
        ...
        def run():
            try:
                process_highlights(file_path, jobs, job_id, num_clips, clip_duration)
...
@highlight_bp.route('/clip/<job_id>/<filename>', methods=['GET'])
